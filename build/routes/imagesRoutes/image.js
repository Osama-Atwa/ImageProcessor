...
var imageReszie_1 = __importDefault(require("../utilities/imageReszie"));
var imageCheck_1 = __importDefault(require("../utilities/imageCheck"));
var images = express_1.default.Router();
// here i am using cache for performance interests
var Cache = new node_cache_1.default();
images.get("/", imageCheck_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var filename, width, height, key, path;
